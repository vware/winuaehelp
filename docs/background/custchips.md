...
- **OCS** (Original Chip Set): This was the
  ...
  colors.
- **ECS** (Enhanced Chip Set): This was the
...
- **AGA** (Advanced Graphics Architecture):
  ...
  as AGA (Advanced Graphics Architecture).  
...
sound played, at least as experienced by a human listener.

## HAM

The HAM (Hold And Modify) mode is one of several graphics
...
all 16.8 million colors of the 24-bit palette in HAM8 mode.

## Copper

Copper is the short name for a "Coprocessor" which is
...
without activity by the main CPU.

## Blitter

Blitter is the short name for another graphics coprocessor
